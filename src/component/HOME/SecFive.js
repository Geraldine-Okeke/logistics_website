...
const AccordionItem = ({ question, answer, isExpanded, toggleAccordion }) => {
  return (
    <div className="flex flex-col bg-gray-200 w-full mt-10">
      ...
      {isExpanded && (
        <p
          className="text-lg font-semibold leading-10 mt-2"
...
export default function SecFive(props) {
  ...
  return (
    <>
      <div className="flex flex-col gap-4 px-4 md:px-10 mt-20 pb-10  ">
        { props.show1 &&
        <h1 className="font-bold text-3xl md:text-4xl text-blue-800">OLEM LOGISTICS Equals best-in-class support</h1>
        } 
        {props.show2 && <span className="font-semibold text-lg md:text-xl w-full md:w-3/4  ">Here at Olem Logistics, we pride ourselves on our best-in-class customer support. 
        ...
        <div className="flex flex-row w-full gap-6 ">
          <div className="flex flex-col w-full  md:w-3/5 ">
            ...
            <AccordionItem
              ...
              answer="Once you type your parcels’ tracking numbers in our search bar, our system searches for them on the websites of hundreds of shipping companies worldwide. The search takes at most a few seconds. Our system presents the 
              results to you in a way that’s clear and easy to understand, so you can know at once the status of each package."
              isExpanded={isExpanded3}
              toggleAccordion={toggleAccordion3}
            />
            <AccordionItem
            question='Shipping Terms and Definitions'
            answer={`Drop Location: This is the Oltem Logistics Warehouse/Depot location where the customer comes to drop the item to be shipped.<br><br>
            Drops First Name: It is the first name of the individual who will be responsible for dropping the parcel/shipment at the Oltem Warehouse/Depot.<br><br>
            Drops Last Name: It is the last name of the individual who will be responsible for dropping the parcel/shipment at the Oltem Warehouse/Depot.<br><br>
            Pickup Location: This is the location where the customer comes to pick up the item that was shipped.<br><br>
            Pick-Up First Name: It is the first name of the individual who will be responsible for picking up the parcel/shipment at the Oltem Warehouse/Depot.<br><br>
            Pick-Up Last Name: It is the last name of the individual who will be responsible for picking up the parcel/shipment at the Oltem Warehouse/Depot.<br><br>
            Goods Description: A detailed description of the goods being shipped. This includes information about the type of goods, quantity, weight, dimensions, and any other relevant characteristics that are essential for proper handling and delivery.<br><br>
