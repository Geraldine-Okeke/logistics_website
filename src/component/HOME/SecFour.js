...
export default function SecFour(){
  ...
  return(
    <>
    <div className="h-auto mt-28   flex flex-row px-4 md:px-10 py-6 " style={containerStyle}>
      <div className=" flex flex-col w-full md:w-1/2 py-4 z-10   " >
        <h1 className='font-bold text-3xl md:text-4xl text-white py-4'>International Package Tracking Couriers</h1>
