...
export default function SecOne(){
  return(
    <>
    <div className="bg-cover bg-center h-screen relative flex text-white items-center " style={{ backgroundImage: `url(${bg})` }}>
      <div className='md:w-1/2 w-full  flex flex-col space-y-6  px-4  '>
          ...
          <div className='flex flex-row gap-2'>
            <div className='border p-4 font-bold'>LEARN MORE</div>
            <div className='border p-4 font-bold bg-purple-500'>ABOUT US</div>
          </div>
      </div>
      <div className='absolute -bottom-16 flex flex-row w-2/3 mx-28 gap-3 bg-white border py-5  '>
      <div className='bg-purple-500 hidden sm:hidden md:hidden lg:flex xl:flex' style={{ backgroundImage: `url(${img})`, backgroundSize: 'cover' }}>
        <h1 className='font-bold text-4xl w-3/4'>Track your product way about</h1>
      </div>
